  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">About PC Builder</h1>
        
        <section className="mb-12">
          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            At PC Builder, we're passionate about helping people create their perfect custom PC. 
          ...
          <div className="grid gap-6">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400">
                Our team of PC building experts is here to help you make informed decisions 
